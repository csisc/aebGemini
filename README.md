...
## Overview
The main objective of this project is to explore the potential of LLMs to automatically process and enhance linguistic resources, which are often limited or of low quality for underrepresented languages. In this context, we applied different LLMs to handle [aebWordNet](https://github.com/NadiaBMKarmani/aebWordNet-Lexicon), a lexicon developed by [Nadia Karmani](https://github.com/NadiaBMKarmani) et al. at [REGIM Lab](https://regimlab.org/), and we evaluated the effectiveness of these models in terms of preprocessing, error correction, and definition generation.
...
## Project Structure
- **Source Code:** The Python scripts to interact with the Gemini API are located in the Jupyter Notebook.
- **Generated Data:** The definitions generated from the LLMs can be found in the processed Excel spreadsheet (Sheet: DONE).
